        ...
        while ($this->currentLine < count($this->risString)) {
            ...
            if (count($matchArray) > 1) // there was a " - ", so there seems to be an item. Check if it really is
            {
                ...
                if (in_array($tmpElementName, $risElements) ||
                    in_array($tmpElementName, $risAuthorElements)
            ...
            if (substr($elementName, 0, 3) == "ris") {
                ...
                if ($elementName == 'EntryType') {
                    ...
                    if (count($date) > 1) {
                        ...
                        switch ($month) {
                            case 1:
                                $currentEntry["month"] = "jan";
                                break;
                            case 2:
                                $currentEntry["month"] = "feb";
                                break;
                            case 3:
                                $currentEntry["month"] = "mar";
                                break;
                            case 4:
                                $currentEntry["month"] = "apr";
                                break;
                            case 5:
                                $currentEntry["month"] = "may";
                                break;
                            case 6:
                                $currentEntry["month"] = "jun";
                                break;
                            case 7:
                                $currentEntry["month"] = "jul";
                                break;
                            case 8:
                                $currentEntry["month"] = "aug";
                                break;
                            case 9:
                                $currentEntry["month"] = "sep";
                                break;
                            case 10:
                                $currentEntry["month"] = "oct";
                                break;
                            case 11:
                                $currentEntry["month"] = "nov";
                                break;
                            case 12:
                                $currentEntry["month"] = "dec";
                                break;
                        }
                    }
                } //USERFIELD
