...
<tr>
    <td colspan='2'>
        <hr>
        <p class='header2'><?php echo __('Login settings (Anonymous access):'); ?></p>
        <p><?php echo __('These login settings determine how anonymous (guest) access to Aigaion is configured.'); ?></p>
    </td>
</tr>
...
<tr>
    <td align='left' colspan='2'>
        <p><img class='icon' src='<?php echo getIconUrl("small_arrow.gif"); ?>'>
	        ...
	        <p>" . __("Note: Be careful in assigning user rights to anonymous accounts!"); ?>
    </td>
</tr>
<tr>
    <td align='left' colspan='2'></td>
...
<tr>
    <td colspan='2'>
        <p class='header2'>
            <?php echo __('Login settings (Delegation of password checking to external module):') . "</p><p>" . __('These login settings determine whether the login password checking is delegated to some external module, and if so, how this is configured.'); ?>
        </p>
    </td>
</tr>
...
$options = array(
    '' => '',
    'hardcoded' => __('Test delegate'),
    'ldap' => __('LDAP Password checking'),
    'pam' => __('PAM Password checking') . '. ' . __('Uses php_pam_auth module'),
    'pwauth' => __('pwauth Password checking') . '. ' . __('Directly from /usr/bin/pwauth'),
);
...
<tr>
    <td align='left' colspan='2'>
        <p><img class='icon' src='<?php echo getIconUrl("small_arrow.gif"); ?>'>
	        ...
	        <p>" . __("Note: check 'Disable internal login' to disallow access to any account not verified using the above module."); ?>
    </td>
</tr>
<tr>
    <td align='left' colspan='2'></td>
...
<tr>
    <td colspan='2'>
        <p class='header2'><?php echo __('Login settings (Special settings):'); ?></p>
        <p></p>
    </td>
</tr>
...
<tr>
    <td colspan='2'>
        <p class='header2'>
            <?php echo __('Login settings (LDAP):') . "</p>" . __("If you use LDAP authentication, you should set the LDAP server and the base DN. (e.g. server: ldap.aigaion.de, base dn: dc=dev,dc=aigaion,dc=de) (That's just an example! We don't really have an LDAP server at Aigaion.de!)"); ?>.
    </td>
</tr>
...
<tr>
    ...
    <td align='left'><input type='text' cols='100' size=50 name='LDAP_SERVER' <?php
...
<tr>
    ...
    <td align='left'><input type='text' cols='100' size=50 name='LDAP_BASE_DN' <?php
...
<tr>
    ...
    <td align='left'><input type='text' cols='100' size=50 name='LDAP_DOMAIN' <?php
...
<tr>
    <td colspan='2'>
        <p class='header2'><?php echo __('Login settings (HTTP Authentication):'); ?></p>
        <?php echo __("'.htpasswd' is a module that uses the .htaccess and .htpasswd login system to determine the name of the logged user, instead of a login form.") . "<br/><br/><b>" . __('Note') . ":</b> " . __('If you select this, be sure that you have the httpauth correctly configured - otherwise you may have problems logging in and then you can also not turn the httpauth login module off without directly accessing the Aigaion database.'); ?>
    </td>
</tr>
